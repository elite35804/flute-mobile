...
import Svg, {Circle, ClipPath, Defs, G, Image, Path, Text, TSpan} from "react-native-svg";
...
class WheelOfFortune extends Component {
  ...
  componentWillUnmount() {
    if (this.props.onRef.current) {
      this.props.onRef.current(undefined)
    }
  }
  ...
  makeWheel = () => {
    ...
    var colors = this.props.colors ? this.props.colors : ['black', 'white', 'white', 'white', 'white', 'white', 'white', 'white', 'white', 'white'];
  ...
  _onPress = () => {
    ...
    Animated.timing(this._angle, {
      toValue: 360 - ((this.winner) * (this.oneTurn / this.numberOfSegments)) + (360 * (duration / 1000)),
      duration: duration,
  ...
  _imageRender = (x, y, value, size) => (
    <Svg height="250" width="200">
      ...
      <Image
        ...
        opacity="1"
        href={value?.products[0]?.images[1]?.url}
        clipPath="url(#clip)"
      />
    </Svg>
  )
